...
export class FaturaIdentificadorVO {
  constructor (
    ...
    if (!FaturaIdentificadorVO.validaIdentificador(fatura_identificador)) { throw new CustomError(CustomErrorType.EntityViolation, 'Identificador de fatura inválido') }
  }
